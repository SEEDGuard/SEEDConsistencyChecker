...
def plot_roc_curve(tri_fpr, tri_tpr, tri_fpr_m, tri_tpr_m, cls_fpr, cls_tpr, m_cls_fpr, m_cls_tpr, a_cls_fpr, a_cls_tpr,
                   tri_fpr_a, tri_tpr_a):
...
def plot_roc_curve_all_strategies(fprs_tprs_bilstm, fprs_tprs_codet5, fprs_tprs_triplet, labels,
                                  legendt="ROC CURVE MIXED DATA"):
...
def plot_pr_curve_all_strategies(fprs_tprs_bilstm, fprs_tprs_triplet, labels,
                                 legendt="PRECISION/RECALL CURVE MIXED DATA"):
    plt.rcParams.update({'figure.figsize': (16, 9), 'figure.dpi': 100})
...
def plot_roc_curve_f1_beta(tri_fpr, tri_tpr, tri_fpr_m, tri_tpr_m, cls_fpr, cls_tpr, m_cls_fpr, m_cls_tpr, a_cls_fpr,
                           a_cls_tpr, tri_fpr_a, tri_tpr_a):
